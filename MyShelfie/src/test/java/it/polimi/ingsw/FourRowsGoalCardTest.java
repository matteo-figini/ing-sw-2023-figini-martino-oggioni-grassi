...
import it.polimi.ingsw.model.commongoals.FourRowsGoalCard;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class FourRowsGoalCardTest {

    private Shelf correctShelf;
    private Shelf uncorrectShelf;
    private FourRowsGoalCard card = new FourRowsGoalCard(2);
    ...
    void setupCorrectShelf(){
        ...
        shelfContent[5][0].setTile(new ItemTile(ItemTileType.BLUE));
        ...
        shelfContent[3][1].setTile(new ItemTile(ItemTileType.WHITE));
        shelfContent[3][0].setTile(new ItemTile(ItemTileType.GREEN));

        shelfContent[2][4].setTile(new ItemTile(ItemTileType.YELLOW));
        ...
        shelfContent[1][3].setTile(new ItemTile(ItemTileType.LIGHTBLUE));
    ...
    void setupUncorrectShelf(){
        ...
        shelfContent[5][4].setTile(new ItemTile(ItemTileType.PINK));
        shelfContent[5][3].setTile(new ItemTile(ItemTileType.GREEN));
        shelfContent[5][2].setTile(new ItemTile(ItemTileType.BLUE));
        shelfContent[5][1].setTile(new ItemTile(ItemTileType.WHITE));
